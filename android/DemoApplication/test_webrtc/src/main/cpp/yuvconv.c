...
Java_com_cyyaw_testwebrtc_temp1_effect_format_LibYuvBridge_i420ToAbgrInternal(
    JNIEnv *env,
    jobject obj,
...
JNIEXPORT void JNICALL
Java_com_cyyaw_testwebrtc_temp1_effect_format_LibYuvBridge_abgrToI420Internal(
        JNIEnv *env,
        jobject obj,
        jobject rgbaBuffer,
        jint width,
