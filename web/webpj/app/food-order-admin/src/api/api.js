...
//获取表格数据
export const getSqlList = (params) => {return axios.get( `${baseUrl}/appAdmin/common/sql/sqlList`, params);}
//保存SQL
export const saveSql = (params) => {return axios.get( `${baseUrl}/appAdmin/common/sql/saveSql`, params);}
// 删除
...
//登录
export const logInFn = (params = {}) => {return axios.post(`${baseUrl}/appAdmin/\${appId}/store/${params.storeId}/login`, params);}
//注册
...
// ===============================================================================================================================================================================================================
//获取企业信息
export const enterpriseFindPage = (params) => {return axios.get( `${baseUrl}/appAdmin/\${appId}/enterprise/enterpriseInfo`, params);}
// 获取菜单
export const apiAdminMenu = (params) => {return axios.get( `${baseUrl}/appAdmin/\${appId}/user/menu`, params);}
//
export const findPageWebImage = (params) => {return axios.get( `${baseUrl}/appAdmin/\${appId}/user/messsssssssssnu`, params);}
