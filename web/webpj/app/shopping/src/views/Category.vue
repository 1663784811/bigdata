              ...
              <div class="swiper-wrapper">
                <template v-for="(category, index) in state.categoryData">
                  <div class="swiper-slide" v-if="state.currentIndex == category.categoryId" :key="index">
                    ...
                    <div class="category-list" v-for="(products, ix) in category.secondLevelCategoryVOS" :key="ix">
                      <p class="catogory-title">{{products.categoryName}}</p>
                      <div class="product-item" v-for="(product, idx) in products.thirdLevelCategoryVOS" :key="idx" @click="selectProduct(product)">
