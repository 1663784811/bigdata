<template>
  ...
  <div class="fromBox">
    <div class="row">
      <van-cell-group>
        <van-field label-align="right" label="标题" placeholder="标题"/>
      </van-cell-group>
    </div>
    <div class="row">
      <van-cell-group>
        <van-field label-align="right" label="简介" placeholder="活动简介"/>
      </van-cell-group>
    </div>
    <div class="row">
      <van-cell-group>
        <van-field label-align="right" label="温馨提示" placeholder="温馨提示"/>
      </van-cell-group>
    </div>
    <div class="row">
      <van-cell-group>
        <van-field label-align="right" label="开始时间" placeholder="开始时间"/>
      </van-cell-group>
    </div>
    <div class="row">
      <van-cell-group>
        <van-field label-align="right" label="结束时间" placeholder="开始时间"/>
      </van-cell-group>
    </div>
    ...
    <div class="row cell">
      ...
      <div class="inputDiv">
        <div>
          <div class="qdBox" v-for="i in 10" :key="i">
            <div class="rowLeft">
              <div class="numBox">1</div>
              <div class="qdName">听心的原因</div>
              <div class="qdPhone">18819617231</div>
            </div>
            <div class="rowRight">
