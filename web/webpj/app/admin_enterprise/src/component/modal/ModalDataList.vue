<template>
  <Modal v-model="modalData.show" title="数据" @on-ok="eventFn('ok')" @on-cancel="eventFn('cancel')" :mask-closable="false" :loading="modalData.loading" width="auto" style="max-width: 1200px; margin-bottom: 300px">
    <div class="modalBox">
      <div>
