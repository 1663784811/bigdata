...
import com.cyyaw.demo.mybatis.ErrorCode;
import com.cyyaw.demo.mybatis.entity.User;
import com.cyyaw.demo.mybatis.entity.enums.AgeEnum;
import com.cyyaw.demo.mybatis.entity.enums.PhoneEnum;
...
public class UserController extends ApiController {
     ...
     */
    @GetMapping("/api")
    public void testError(String test) {
        Assert.notNull(ErrorCode.TEST, test);
        ApiResult<String> success = success(test);
