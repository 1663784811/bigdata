package com.cyyaw.weixin.config.weixin.miniapp;
...
public class WxMaConfiguration {
    ...
    public static WxMaService getMaService(String appid) {
        ...
        if (wxService == null) { throw new IllegalArgumentException(String.format("未找到对应appid=[%s]的配置，请核实！", appid)); }
        return wxService;
    }
    ...
    public void init() {
        ...
        if (configs == null) {throw new WxRuntimeException("大哥，拜托先看下项目首页的说明（readme文件），添加下相关配置，注意别配错了！"); }
