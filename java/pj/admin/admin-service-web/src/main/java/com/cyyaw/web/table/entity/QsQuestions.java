...
@Data
@Entity
@Table(name = "qs_questions")
@org.hibernate.annotations.Table(appliesTo = "qs_questions", comment = "问题")
public class QsQuestions implements BaseEntity<Integer>, Serializable {
    ...
    @Basic
    @Column(name = "questions", columnDefinition = "text COMMENT '问题'")
