...
@Data
@Entity
@Table(name = "a_activity_range_type")
@org.hibernate.annotations.Table(appliesTo = "a_activity_range_type", comment = "使用范围类型表")
public class AActivityRangeType implements Serializable {
