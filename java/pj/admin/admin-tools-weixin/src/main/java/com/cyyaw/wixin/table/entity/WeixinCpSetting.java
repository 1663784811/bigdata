...
@Data
@Entity
@Table(name = "weixin_cp_setting")
@org.hibernate.annotations.Table(appliesTo = "weixin_cp_setting", comment = "微信企业设置")
public class WeixinCpSetting implements BaseEntity<Integer>,  Serializable {
