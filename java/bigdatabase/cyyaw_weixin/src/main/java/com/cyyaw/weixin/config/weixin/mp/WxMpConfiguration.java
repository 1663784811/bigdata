package com.cyyaw.weixin.config.weixin.mp;

import com.cyyaw.weixin.config.weixin.mp.handler.*;
...
public class WxMpConfiguration {
    ...
    public WxMpService wxMpService() {
        ...
        if (configs == null) {throw new RuntimeException("大哥，拜托先看下项目首页的说明（readme文件），添加下相关配置，注意别配错了！"); }
